  ...
  head: () => ({
    meta: [
      ...
      { title: "Dreambuilders Venue Hire — Auditorium, Function Rooms & Lounge" },
      {
        name: "description",
        content:
          "Hire the Main Auditorium, Function Rooms or Lounge at Dreambuilders Church in Hoppers Crossing. Get an instant estimate and submit your booking enquiry.",
      },
      ...
      { name: "description", content: "Hire the 250-600 seat Main Auditorium, Function Rooms, Lounge or commercial Kitchen at Dreambuilders Church in Hoppers Crossing. Instant online estimates." },
      { property: "og:description", content: "Hire the 250-600 seat Main Auditorium, Function Rooms, Lounge or commercial Kitchen at Dreambuilders Church in Hoppers Crossing. Instant online estimates." },
      { name: "twitter:description", content: "Hire the 250-600 seat Main Auditorium, Function Rooms, Lounge or commercial Kitchen at Dreambuilders Church in Hoppers Crossing. Instant online estimates." },
